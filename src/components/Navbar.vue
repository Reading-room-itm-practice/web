<template>
	<el-row :class="getTheme + '-navbar nav'" ref="navbar">
		...
		<el-col :span="2" :offset="5">
			...
			<router-link to="/admin" v-if="getUserRole.includes(UserRoles.ADMIN)" class="break-items"
				>Admin</router-link
			>
		</el-col>
		<el-col :span="10">
...
export default class Navbar extends Vue {
	...
	@Action [UserStoreMethods.setTheme]: (selectedMode: boolean) => void;

	@Getter [UserStoreMethods.isLoggedIn]: () => boolean;
