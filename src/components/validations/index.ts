...
export const rules = {
  ...
  email: [
    new RequiredRule(i18n.t('validation.email.required')),
    new TypeRule(i18n.t('validation.email.type'))
  ],
  password: [
    new RequiredRule(i18n.t('validation.password.required'))
  ],
  passwordConfirmation: [
    new RequiredRule(i18n.t('validation.passwordConfirmation.required'))
  ]
}
